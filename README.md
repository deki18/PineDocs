# PineDocs - 文档向量管理系统
![alt text](image.png)
PineDocs 是一个基于 Gradio 的文档管理和向量搜索工具，支持将多种格式的文档上传到 Pinecone 向量数据库，并进行语义搜索。本工具旨在解决 Pinecone 向量库的本地文档管理需求，提供文档解析、Markdown 转换、上传管理、智能搜索及删除等一站式功能，让您能够便捷高效地管理 Pinecone 向量数据库中的文档资源。
对于向量嵌入的方案进行了仔细推敲，对复杂的pdf文档、xlsx表格等进行了特殊处理，确保向量嵌入的准确性和效率，支持批量化处理，能够高效处理大量文档。
